...
#	$ColorRect/anim.play("to_zero")
	...
	$Player2/pivot/planet/AnimationPlayer2.play("1Action")
	$Player2/pivot/planet/AnimationPlayer3.play("2Action")
	$Player2/pivot/planet/AnimationPlayer4.play("3Action")
	$Player2/pivot/planet/AnimationPlayer5.play("4Action")
	$Player2/pivot/planet/AnimationPlayer6.play("Icosphere001Action")
	$Player2/pivot/planet/AnimationPlayer.play("sputnikAction")
	pass
